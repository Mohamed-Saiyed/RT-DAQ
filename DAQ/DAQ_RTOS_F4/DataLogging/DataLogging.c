...
void DataLogging_LogDAQ(DAQStrcut* DAQ)
{
 if(DataLoggingInitState == DATA_LOG_INITIALIZED)
 {
		...
		snprintf(WheelsRPM[0],5,"%d",DAQ->WheelsRPM[0]);
		snprintf(WheelsRPM[1],5,"%d",DAQ->WheelsRPM[1]);
		snprintf(WheelsRPM[2],5,"%d",DAQ->WheelsRPM[2]);
		snprintf(WheelsRPM[3],5,"%d",DAQ->WheelsRPM[3]);
