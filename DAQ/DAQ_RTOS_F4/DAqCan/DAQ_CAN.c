...
//static HAL_StatusTypeDef HAL_CAN_AddTxMessage_IMUxy(CAN_HandleTypeDef *hcan1, CAN_TxHeaderTypeDef *pHeader, uint32_t *pTxMailbox);
//static HAL_StatusTypeDef HAL_CAN_AddTxMessage_IMUz_RollPitch(CAN_HandleTypeDef *hcan1, CAN_TxHeaderTypeDef *pHeader, uint32_t *pTxMailbox);
